jQuery(document).ready(function() {
    ...
    /* testimonior-slider */
    jQuery(".slider-product .slider-banner").owlCarousel({
        autoplay: true,
        items: 1, 
        itemsDesktop: [1024, 1], 
     ...
     /* testimonior-slider */
    jQuery(".testimonior-slider .testimonior").owlCarousel({
        autoplay: true,
        items: 1, 
        itemsDesktop: [1024, 1], 
        itemsDesktopSmall: [900, 1],
...
jQuery()
    .ready(function() {
        (function(element) {
            ...
            ajax_url = "http://www.blockcommerce.com/producttabs/index/ajax";
            catids = '39';
...
$(function () {
    $("div.item-group").slice(0, 1).show();
    $("#loadMore").on('click', function (e) {
        e.preventDefault();
        $("div.item-group:hidden").slice(0, 1).slideDown();
        if ($("div.item-group:hidden").length == 0) {
            $("#loadMore").addClass('ready');
            $("#loadMore").text('/ All ready /');
            return false;
            e.preventDefault();
        }
        $('html,body').animate({
